#ifndef COLLOCATED_ENERGY_CTRL_H_
#define COLLOCATED_ENERGY_CTRL_H_
...
#include "drake_control_algorithms/utils/parameters.hpp"
...
class CollocatedEnergyCtrl : public drake::systems::LeafSystem<double> {
    ...
    private:
        ...
        drake::systems::InputPortIndex state_port_idx_;
        drake::systems::OutputPortIndex control_port_idx_;
